...
# library(biomartr)
# getDatasets(mart='ENSEMBL_MART_ONTOLOGY')$dataset
# mmusfilters <- organismFilters('Mus musculus')
# mmusttrs <- organismAttributes('Mus musculus')

# getMarts()

# GO_tbl <- biomartr::getGO(organism = "Mus musculus",database = 'ENSEMBL_MART_ONTOLOGY')
