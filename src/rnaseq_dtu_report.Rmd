...
if(!file.exists(here('data/dtuobject.rds'))){
  dtuobject <- create_dtuobject(dds, blind = TRUE)
  saveRDS(dtuobject,here('data/dtuobject.rds'))
}else{
  dtuobject<-readRDS(here('data/dtuobject.rds'))
}
